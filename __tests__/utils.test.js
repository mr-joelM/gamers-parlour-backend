...
describe("formatCategoriesData", () => {
  ...
  it("should return an array of arrays with the values of the input objects ", () => {
    ...
    expect(formatCategoriesData(array)).toEqual([
...
describe("formatUsersData", () => {
  ...
  it("should return an array of arrays with the values of the input objects ", () => {
    ...
    expect(formatUsersData(array)).toEqual([
      [
        "dav3rid",
        "dave",
        "https://www.golenbock.com/wp-content/uploads/2015/01/placeholder-user.png",
...
describe("formatedReviewsData", () => {
  ...
  it("should return an array of arrays with the values of the input objects ", () => {
    ...
    expect(formatReviewsData(array)).toEqual([
      [
...
describe("formatCommentsData", () => {
  it("should return a new array", () => {
    const commentsData = [];
    const reviewsData = [];
    expect(formatCommentsData(commentsData, reviewsData)).not.toBe(
      commentsData
    );
    expect(formatCommentsData(commentsData, reviewsData)).not.toBe(reviewsData);
    expect(Array.isArray(formatCommentsData(commentsData, reviewsData))).toBe(
      true
    );
  });
  it("should return formatted data when passed an array of length 1", () => {
    const commentsData = [
      {
    ...
    expect(formatCommentsData(commentsData, reviewsData)).toEqual([
      [
        "mallionaire",
        5,
        13,
  ...
  it("should return formatted data when passed an array of length > 1", () => {
    ...
    expect(formatCommentsData(commentsData, reviewsData)).toEqual([
      ...
      ["chris", 22, 2, new Date(1610964545410), "A new comment"],
    ]);
  });
  it("should not mutate original array", () => {
    const commentsData = [
    ...
    formatCommentsData(commentsData, reviewsData);
